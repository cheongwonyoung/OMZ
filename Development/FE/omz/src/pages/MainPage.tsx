      ...
      <div className="flex flex-col justify-center items-center gap-[50px]">
        <div className="flex justify-end items-end gap-[25px]">
          ...
          >
            ...
            <p className="text-base text-center font-bold">New Friends</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-base text-center font-bold">Mini Room</p>
          </Link>
          <Link
            to={`/mypage/${memberId}`}
            className="flex flex-col justify-center items-center hover:scale-105"
          >
            ...
            <p className="text-base text-center font-bold">My Page</p>
          </Link>
        </div>
        <div className="flex justify-center items-end gap-[25px]">
          ...
          >
            ...
            <div className="flex-grow-0 flex-shrink-0 w-[95px] h-[30px]">
              <p className="text-base text-center font-bold">My Friends</p>
            </div>
          </Link>
          <Link
            to="/chatting/1"
          ...
          >
            ...
            />
            <div className="flex-grow-0 flex-shrink-0 w-[95px] h-[30px]">
              <p className="text-base text-center font-bold">Chatting</p>
            </div>
          </Link>
          <Link
            to="/community"
          ...
          >
            ...
            <div className="flex-grow-0 flex-shrink-0 w-[95px] h-[30px]">
              <div className="w-[72px] h-4">
                <p className="text-base text-center font-bold">Community</p>
              </div>
            </div>
          </Link>
        </div>
