...
public class ChatRoomRepository {
    ...
    public void enterChatRoom(String roomId, String sessionId, String username) {
        ...
        System.out.println("[ChatRoomRepository enterChatRoom] getRoomIdByRedisCache : " +  opsHashEnterRoom.get(SESSION_ID, sessionId));
        System.out.println("[ChatRoomRepository enterChatRoom] getUserNameByRedisCache : " +  opsHashEnterRoom.get(CHAT_ROOM_ID_ + roomId, sessionId));
